...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-2-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
``` r
#ggplot(gapminder, x = lifeExp, y = gapminder) +        ## dont miss aes function
#  gemo_point()

ggplot(gapminder) +        ## dont miss aes function
  geom_point(aes(x = lifeExp, y = gdpPercap))
```

![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-5-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-7-1.png)

1.  Instead of a histogram, let's create a kernel density plot.

``` r
ggplot(gapminder, aes(lifeExp)) +
  geom_density(bw = 1)    # bw will change the width of bumps
```

![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-8-2.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-10-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
``` r
a + geom_point(alpha = 0.1)   # show where is more density where is less density
```

![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-12-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-14-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-15-1.png)
...
![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-16-1.png)

``` r
c + geom_line(aes(group = country), alpha = 0.2)
```

![](cm006-exercise-df_files/figure-markdown_github/unnamed-chunk-16-2.png)
